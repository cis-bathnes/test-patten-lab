...
/***/ (function(module, exports, __webpack_require__) {
	...
	fabricator.buildColorChips = function () {
	  ...
	  var chips = document.querySelectorAll('.ui-color-chip');
	
	  for (var i = chips.length - 1; i >= 0; i--) {
	    var color = chips[i].querySelector('.ui-color-chip__color').innerHTML;
	...
	fabricator.allItemsToggles = function () {
	  ...
	  var toggleAllControls = document.querySelectorAll('.ui-controls [data-ui-toggle-control]');
	  var options = fabricator.getOptions();
	
	  // toggle all
	  var toggleAllItems = function toggleAllItems(type, value) {
	
	    var button = document.querySelector('.ui-controls [data-ui-toggle-control=' + type + ']');
	  ...
	  for (var i = 0; i < toggleAllControls.length; i++) {
	    ...
	    toggleAllControls[i].addEventListener('click', function (e) {
	      ...
	      var type = e.currentTarget.getAttribute('data-ui-toggle-control');
	      var value = e.currentTarget.className.indexOf('ui-active') < 0;
	...
	fabricator.singleItemToggle = function () {
	  ...
	  var itemToggleSingle = document.querySelectorAll('.ui-item-group [data-ui-toggle-control]');
	...
	fabricator.bindCodeAutoSelect = function () {
	  ...
	  var codeBlocks = document.querySelectorAll('.ui-item-code');
